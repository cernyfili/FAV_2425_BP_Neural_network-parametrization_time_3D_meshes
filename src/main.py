...
from utils.constants import DEFAULT_NN_CONFIG, FilePathConfig, TrainConfig, \
    ...
    nn_lr, default_processed_folderpath
...
def main():
    ...
    processed_ball_folderpath = str(os.path.join(default_processed_folderpath, "ball"))
    processed_man_folderpath = str(os.path.join(default_processed_folderpath, "casual_man_1000"))
    ...
    train_config_list = [
        ...
        #     file_path_config=FilePathConfig.create_test_mode(data_foldername="ball", processed_session_folderpath="ball_standard"),
        #     num_clusters=CDataPreprocessing.NUM_CLUSTERS, num_surface_points=CDataPreprocessing.NUM_SURFACE_POINTS,
        #     time_steps=CDataPreprocessing.MAX_TIME_STEPS),
        # TrainConfig(
        #     nn_config=NNConfig(nn_max_epochs=nn_max_epochs, nn_patience=nn_patience, nn_batch_size=nn_batch_size,
        ...
        #                                                          processed_ball_folderpath, "ball_uvstreach")),
        #     num_clusters=CDataPreprocessing.NUM_CLUSTERS,
